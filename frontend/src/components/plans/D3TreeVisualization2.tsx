...
//     // Configure tree layout with dynamic size and improved sibling spacing
//     // Since we have zoom functionality, we can use more space than the visible area
//     const treeLayout = d3.tree<Milestone>()
//       .size([containerWidth * 1.2, containerHeight * 0.8]) // Expanded layout size beyond container to allow for better spacing
//       .separation((a, b) => {
//         // Increase separation between siblings to make the tree more readable
//         // This will allow the user to see the structure clearly and use zoom when needed
//         return a.parent === b.parent ? 7.5 : 10.0; // Much larger separation between siblings and between different branches
//       });
...
//     // Add fullscreen icon - different icons based on fullscreen state
//    if (isFullScreen) {
...
//         // Calculate scale to fit the content with better default view
//         // We're intentionally setting a smaller scale to better show the spacing between siblings
//         // The user can always zoom in for a closer look or zoom out to see the full tree
//         const scale = Math.min(
//           0.85 * svgRect.width / gBounds.width,
//           0.85 * svgRect.height / gBounds.height
//         );

...
import {
  ...
  updateMilestone,
  updatePlan,
} from "../../features/plans/planThunks";
import {
  selectActivePlan,
  selectPlanLoading,
  selectPlanError,
} from "../../features/plans/planSelectors";
  ...
  const handleToggleComplete = (milestoneId: string, isComplete: boolean) => {
    ...
    if (milestone) {
      ...
      dispatch(
        ...
        console.log(
          `Milestone ${milestoneId} marked as ${
        ...
        dispatch(
          addNotification({
            ...
            message: `The milestone status has been updated to ${
              isComplete ? "complete" : "incomplete"
            }.`,
          })
        );
      ...
      <>
        ...
        <MainLayout>
          <div className="flex justify-center items-center h-64">
            <div className="animate-pulse text-roadmap-primary">
  ...
  return (
    <>
      ...
      <MainLayout>
          ...
          >
            ...
            >
              <CardContent className="p-3">
                ...
                <div>
                  <p className="text-xl font-bold mb-0.5">
                    {formatDate(activePlan.updatedAt)}
                  </p>
                  <p className="text-xs text-gray-600 dark:text-gray-400">
                    Last modified
                  </p>
              ...
              <Card>
                <CardContent className="p-6 text-center">
                  <p className="text-gray-500 dark:text-gray-400 mb-4">
                    This plan doesn't have any milestones yet. Add a milestone
                    to get started!
                  </p>
                  <Button
                    variant="outline"
                  ...
                  <div key={`${milestone.id}`}>
                    ...
                    >
                      ...
                      <div
                        ...
                        style={{
                          backgroundColor:
                            statusConfig[milestone.status].ribbonColor,
                          zIndex: 1,
                        }}
                        aria-hidden="true"
                      />
                      ...
                      <CardContent className="p-4 pl-6">
                        <div className="flex items-center justify-between">
                          ...
                          <div className="flex space-x-2">
                            <Button
                              variant={
                                milestone.isComplete ? "success" : "outline"
                              }
                              size="xs"
                              className="flex items-center gap-2"
                              onClick={(e) => {
        ...
        {/* Milestone Form Modal - For Adding or Editing */}
        <Modal
              ...
              parentOptions={allMilestones
                .filter((milestone) => {
                  ...
                  if (
                    isEditing &&
                    selectedMilestone &&
                    milestone.parentId === selectedMilestone
                  ) {
                    return false;
                  }
                  return true;
        ...
        <Modal
          ...
          onClose={handlePlanUpdateSuccess}
          title={"Edit Plan"}
          size="md"
        >
          <PlanForm
